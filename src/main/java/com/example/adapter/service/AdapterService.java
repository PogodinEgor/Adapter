...
import com.example.adapter.dto.Coordinates;
...
public class AdapterService {
    ...
    /**
     * Метод для конвертации объекта MsgA в объект MsgB
     * содержит запрос в погодный сервис
     * @param msgA - входящий объект из сервиса A
     * @return msgB
     */
    public MsgB convertToMsgB(MsgA msgA) throws NotConnectionWeatherApiException {
        MsgB msgB = new MsgB();
